...
export default function StakePage() {
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      setStaked(true);
      setTimeout(() => router.push('/start/verify'), 1200);
    } catch (error) {
      ...
      <h1 className="text-5xl font-bold tracking-tight mb-6 text-center">
        ...
        <Card className="w-[400px] max-w-full overflow-hidden gap-2 relative">
          <CardHeader className="z-10">
            <CardTitle className="text-2xl">Stake FTN</CardTitle>
            <CardDescription>
              Stake to get started and earn your first rank.<br />
              You can upload documents later to unlock higher ranks!
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4 items-center">
            {!authenticated ? (
              ...
              <>
                <div className="w-full">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    ...
                    Silver: 0.1 FTN<br />
                    <span className='text-neutral-400'>Higher ranks require AI verification and a second stake.</span>
                  </div>
                </div>
                <button
                  onClick={handleStake}
              ...
              <div className="w-full text-center">
                ...
                <div className="text-green-600 font-medium mb-4">Redirecting to verification...</div>
              </div>
            )}
          </CardContent>
        </Card>
